...
`pylon stop` and `pylon restart` print instructions -- they do not signal the running process directly. To control the daemon as a background service, use [systemd](/running/daemon).
