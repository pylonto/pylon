---
title: "pylon upgrade, version, completion — utility commands"
sidebarTitle: "upgrade / version / completion"
...
See [Run Pylon as a systemd service](/operations/systemd) for full details.
